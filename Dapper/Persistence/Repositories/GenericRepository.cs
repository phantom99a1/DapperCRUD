...
namespace Persistence.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public GenericRepository(ISqlConnectionProvider sqlConnectionProvider, 
            IEntityAttributeValuesProvider entityAttributeValuesProvider)
        {
        ...
        {
            await using var sqlConnection = _sqlConnectionProvider.GetConnection();
            var tableName = _entityAttributeValuesProvider.GetTableName<T>();
        ...
        public async Task<IEnumerable<T>> GetAllAsync()
        {
            ...
            //table name
            var tableName = _entityAttributeValuesProvider.GetTableName<T>();
            var columnNamePropertyNameDict = _entityAttributeValuesProvider.GetColumnsAndModelPropertyNames<T>();
        ...
        public async Task<T?> GetByIdAsync(int id)
        {
            ...
            (string? columnName, string propertyName) = _entityAttributeValuesProvider.
                        GetKeyColumnNamePropertyName<T>();

            var keyColumnName = columnName;
        ...
        public async Task<bool> UpdateAsync(T entity)
        {
            ...
            (string? keyColumnName, string keyPropertyName) = _entityAttributeValuesProvider.
                GetKeyColumnNamePropertyName<T>();
